    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-gray-200 shadow-xl shadow-gray-100 p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <span className="flex items-center gap-1.5 text-sm text-wa-green font-semibold">
            <span className="w-2 h-2 bg-wa-green rounded-full animate-pulse"></span> Running
          </span>
        </div>
        <div className="space-y-3">
          <div className="flex justify-between items-center py-2 border-b border-gray-50">
            <span className="text-sm text-gray-500">Groups monitored</span>
            <span className="text-sm font-semibold text-gray-800">{groupCount} groups</span>
          </div>
          <div className="flex justify-between items-center py-2 border-b border-gray-50">
            <span className="text-sm text-gray-500">Check interval</span>
            <span className="text-sm font-semibold text-gray-800">{config.interval} min</span>
          </div>
          <div className="flex justify-between items-center py-2 border-b border-gray-50">
            <span className="text-sm text-gray-500">Reporting to</span>
            <span className="text-sm font-semibold text-gray-800">
              {config.bossNumbers[0] || 'None'}
            </span>
          </div>
          <div className="flex justify-between items-center py-2 border-b border-gray-50">
            <span className="text-sm text-gray-500">Keywords tracked</span>
            <span className="text-sm font-semibold text-gray-800">{keywordCount} keywords</span>
          </div>
          <div className="flex justify-between items-center py-2">
            <span className="text-sm text-gray-500">Last checked</span>
            <span className="text-sm font-semibold text-gray-800">Just now</span>
          </div>
        </div>
      </div>
          ...
          <div className="bg-white rounded-lg p-3 text-sm text-gray-700 space-y-2">
            ...
            <ul className="space-y-1.5 text-xs text-gray-600 ml-4">
              <li className="flex items-start gap-2">
                ...
                <span>Found <strong>"deadline"</strong> mentioned 3 times in <strong>Marketing Team</strong></span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-wa-green mt-0.5">●</span>
                <span><strong>"urgent"</strong> flagged in <strong>Sales Pipeline</strong> by @John</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-wa-green mt-0.5">●</span>
                <span>No mentions of <strong>"Q4 report"</strong> today</span>
              </li>
            </ul>
          </div>
          <p className="text-xs text-gray-400 text-center">
            Report sent to {config.bossNumbers[0] || '+60 (10) 224-4567'} via WhatsApp
          </p>
        </div>
      </div>
      ...
      {config.isSaved && (
        <div className="bg-wa-dark text-white rounded-xl p-4 flex items-center gap-3 shadow-xl animate-slide-up">
