    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div id="header-middle-menu" className="hidden md:flex items-center gap-8">
      ...
      <div id="mobileMenu" className={`md:hidden ${menuOpen ? 'block' : 'hidden'} bg-white border-t border-gray-100`}>
